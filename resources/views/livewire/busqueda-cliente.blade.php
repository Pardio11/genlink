<div class=" h-[90vh] bg-black flex flex-col justify-center items-center">
    <div class="container ">
        ...
        <h1 class="text-center text-white uppercase text-xl top-0">Abarrotes Doña Mari</h1>
    </div>
    ...
    <div class="texto mt-10">
        ...
        <div class="w-[100%] text-white text-lg flex flex-col items-start">
            Dinero en caja: <span class="text-[#777]">$8947</span>
        </div>
        <div class="w-[100%] text-white text-lg flex flex-col items-start">
            Comisiones generadas: <span class="text-[#777]">$350</span>
        </div>
    </div>
    ...
    <div class="w-[50%] flex left-0 mt-4">     
        ...
        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-[30%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar cliente">
